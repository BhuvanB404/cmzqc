...
int main() {
    std::ifstream csv_file("../input_files/CPTAC_CompRef_00_iTRAQ_01_2Feb12_Cougar_11-10-09_ids.csv");
    if (!csv_file.is_open()) {
    ...
    //Generates temp JSON to verify data
    ...
    //  Verify inputFiles and analysisSoftware in runQualities
    ...
    // create the JSON with indentation for readability
